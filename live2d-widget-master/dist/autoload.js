...
//const live2d_path = 'https://imgedge.875949.xyz/live2d-widget-master/dist/';
...
(async () => {
  ...
  await Promise.all([
    loadExternalResource('https://imgedge.875949.xyz/live2d-widget-master/dist/waifu.css'),
    loadExternalResource('https://imgedge.875949.xyz/live2d-widget-master/dist/waifu-tips.js')
  ]);
  // For detailed usage of configuration options, see README.en.md
  // 配置选项的具体用法见 README.md
  initWidget({
    waifuPath: 'https://imgedge.875949.xyz/live2d-widget-master/dist/waifu-tips.json',
    // cdnPath: 'https://fastly.jsdelivr.net/gh/fghrsh/live2d_api/',
    cubism2Path: 'https://imgedge.875949.xyz/live2d-widget-master/dist/live2d.min.js',
